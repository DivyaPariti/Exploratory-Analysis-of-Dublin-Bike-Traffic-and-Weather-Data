---
title: "Exploratory Analysis of Dublin Bike Traffic and Weather Data"
author: "Divya Pariti"
format: pdf
editor: visual
---
...
In this report we will analyse the data set `dublin-bikes.txt` contains variable concerning bike traffic and weather conditions in Dublin from September 1st 2022 at 12am to August 31st 2023 at 11pm. The data set contains 12 variables.
...
### Q2. Use ggplot2 to create a time series plot of the maximum and minimum daily temperatures. \[The two time series must be on the same plot.\]
...
## Task 3 : Creativity Do something interesting with these data! Create two plots or two tables or one plot and one table showing something we have not discovered above already and outline your findings.
